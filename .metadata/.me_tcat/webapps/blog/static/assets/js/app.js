...
$(document).ready(function(){
   ...
   // $("table").css("background","#fff");
    ...
    $("button,button[type=submit],input[type=submit]").addClass("btn-round btn-sm btn-xs  btn btn-primary");
    $("table th").attr("style","");
   ...
   // $("table td a").addClass("btn btn-"+b[rnd(0,b.length-1)]);
    ...
    $("form").css("width","50%"); 
    $("table thead tr,thead td").css("background"," #f1f1f1");
    $("table thead tr,thead td").css("color","#333");
