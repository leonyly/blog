...
<div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 发布动态
                    </div>
                ...
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            ...
                            action="<%=basePath %>article/article/save" method="POST">
                                ...
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">mp4或mp3</label>
                                    <div class="am-u-sm-9">
                                  ...
                                  <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        ...
                                        <input type="checkbox" value="${u.id }" name="tags" checked>
                                        ${u.title }
                                        </c:forEach>
                                        <small></small>
                                    </div>
