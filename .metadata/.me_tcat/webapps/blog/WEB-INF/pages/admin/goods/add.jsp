...
<body data-type="index">
            ...
            <div class="row  am-u-md-7" style="padding-left:30px;padding-right:30px;">
              
<div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                    <h4>
                        <span class="am-icon-plus"></span> 发布预定产品
                        </h4>
                    </div>
                ...
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-12">
                            <form class="am-form am-form-horizontal" enctype="multipart/form-data" action="<%=basePath %>goods/goods/save" method="POST">
                                ...
                                <div class="am-form-group">
                                  ...
                                  <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">所属类别</label>
                                    <div class="am-u-sm-9">
                                    <select name="category">
                                       ...
                                       <a  href="<%=basePath %>infocate/infocate/list">  类别管理 </a> 
                                        <small></small>
                                    </div>
                                </div>
                                ...
                                <!-- 
                                   <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">3D展示资源</label>
                                    <div class="am-u-sm-9">
                                        <input type="file"  name="vpath"  required placeholder="">
                                        <small></small>
                                    </div>
                                </div>
                                 -->
