...
<div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 新增专业
                    </div>
                ...
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" action="<%=basePath %>major/major/save" method="POST">
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">专业名称</label>
                                    <div class="am-u-sm-9">
                                        <input type="text" name="major_name" required placeholder="">
                                        <small></small>
                                    </div>
                                </div>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-9">
                                        ...
                                        <option value="${u.id }">${u.collegename }</option>
                                        </c:forEach>                                        
                                        </select>
                                        <small></small>
                                    </div>
