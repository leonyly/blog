...
<div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 照片管理
                    </div>
...
<div class="am-u-sm-12 am-u-md-12">
                        ...
                        <div class="am-u-sm-12 am-u-md-12">
                         ...
                         <div class="row">
                                   ...
                                   <div class="col-md-3">
                                   	<img style="width:100%;height:350px;" src="<%=basePath %>${u.path}">
                                   	<br/>
                                   	<a href="<%=basePath %>photo/photo/delete2?id=${u.id}&aid=${u.aid}" class="am-btn am-btn-success">删除</a>
                                   </div>
                                     </c:forEach>
                         </div>
  ...
  <c:if test="${!empty message}">		
		...
		<script type="text/javascript" src="<%=basePath %>static/diyUpload/js/webuploader.html5only.min.js"></script>
                <script type="text/javascript"  src="<%=basePath %>static/diyUpload/js/zh_cn_diyUpload.js"></script>
                <script type="text/javascript">

                    $(document).ready(function () {
                        var uploader = $('#test').diyUpload({
                            url: "<%=basePath %>diyUpload?aid=${aid}",
                            error: function (err) {
                                console.info(err);
                            },
                            chunked: true,
