...
<div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 创建相册
                    </div>
                ...
                <div class="tpl-block ">
                    ...
                    <div class="am-g tpl-amazeui-form">
                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            <form class="am-form am-form-horizontal" action="<%=basePath %>album/album/save" method="POST" style="display: block">
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">相册名称</label>
                                    <div class="am-u-sm-9">
                                ...
                                <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">相册封面</label>
                                    <div class="am-u-sm-9">
                                  ...
                                  <div class="am-form-group">
                                    <label for="user-name" class="am-u-sm-3 am-form-label">相册描述</label>
                                    <div class="am-u-sm-9">
                                        <textarea name="description" required></textarea>
                                        <small></small>
                                    </div>
                                </div>
<div class="style" style="display: block"></div>
                                <div>
                                <div style="display: block" class="am-form-group">
