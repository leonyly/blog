...
<div class="tpl-portlet-components">
                <div class="portlet-title">
                    <div class="caption font-green bold">
                        <span class="am-icon-code"></span> 我的相册
                    </div>
                            ...
                            <table class="am-table am-table-striped am-table-hover table-main">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="table-title">相册名称</th>
                                            <th class="table-title">创建人</th>
                                            <th class="table-title">封面</th>
                                                    <th class="table-title">图片管理</th>                                       
                                    ...
                                    <tbody>
                                     ...
                                     <tr>                                            
                                            ...
                                            <td>
                                            <a href="<%=basePath %>photo/photo/list?aid=${u.id}" class="am-btn button am-btn-primary">管理</a>
                                            </td>
                                            <td>${u.created} }</td>
                                            <td>
                                                <div class="am-btn-toolbar">
                                                    <div class="am-btn-group am-btn-group-xs">
                                                        <a href="<%=basePath %>album/album/edit?id=${u.id}" class="am-btn am-btn-default am-btn-xs am-text-secondary"><span class="am-icon-pencil-square-o"></span> 编辑</a>                                                        
                                                        <a href="<%=basePath %>album/album/delete?id=${u.id}"  class="am-btn am-btn-default am-btn-xs am-text-danger am-hide-sm-only"><span class="am-icon-trash-o"></span> 删除</a>
                                                    </div>
                                                </div>
                                            </td>
                                      </tr>
